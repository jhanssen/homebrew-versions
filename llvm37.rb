...
class Llvm37 < Formula
  ...
  resource "isl" do
    url "http://isl.gforge.inria.fr/isl-0.15.tar.gz"
    sha256 "02fb67c487df76745b6bae87d3a33d50e00ff14791544eae44fcc076edbf7987"
  end
  ...
  def install
    ...
    if build.with? "asan"
      ...
      inreplace "tools/clang/runtime/compiler-rt/Makefile", /CC=\"\$\(ToolDir\)\/clang\" \\/, "\\"
    end
